...
Recent audits covered fixed-target native document editors, background
terminals, rate limits and App Server restart ownership. Earlier controller
...
- 702 deterministic frontend/unit tests across 129 files;
