      ...
      <IconCard
        ...
        trailing={controller.authPending ? (
          <div className="account-auth-buttons">
            <IconButton icon={ExternalLink} label={t("account.auth.reopen")} onClick={() => void controller.reopenLogin()} size="medium" variant="secondary" />
            <IconButton icon={X} label={t("common.cancel")} onClick={() => void controller.cancelLogin()} size="medium" variant="secondary" />
          </div>
        ) : !account ? (
          <IconButton
          ...
          >
            ...
            <IconButton label={t("common.cancel")} onClick={() => setConfirmingLogout(false)} size="medium" variant="secondary" />
            <IconButton
              className="danger"
          ...
          <IconButton icon={LogOut} label={t("account.auth.logout")} onClick={() => setConfirmingLogout(true)} size="medium" variant="secondary" />
        ) : (
