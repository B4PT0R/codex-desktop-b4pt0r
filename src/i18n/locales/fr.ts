export const fr = {
  ...
  "integrations.apps.categories": "Catégories d’Apps",
  "integrations.apps.categoryLabel": "Catégories",
  "integrations.apps.categoryAll": "Toutes les catégories",
  "integrations.apps.alphabeticalIndex": "Index alphabétique",
  "integrations.apps.alphabetLabel": "A–Z",
  "integrations.apps.initialAll": "Tout",
  ...
  "integrations.skills.createAction": "Créer un skill",
  "integrations.skills.createTitle": "Créer un skill",
  "integrations.skills.createDetail": "Donnez à Codex un workflow ciblé qu’il saura reconnaître et réutiliser.",
  "integrations.skills.createLevel": "Étape de création du skill",
  "integrations.skills.createLevel.essential": "Essentiel",
  "integrations.skills.createLevel.instructions": "Instructions",
  "integrations.skills.createName": "Nom",
  "integrations.skills.createNameDetail": "Le nom du dossier est normalisé en minuscules avec des tirets.",
  "integrations.skills.createNamePlaceholder": "relire-changements",
  "integrations.skills.createFolder": "Dossier",
  "integrations.skills.createDescription": "Quand Codex doit-il l’utiliser ?",
  "integrations.skills.createDescriptionDetail": "Décrivez ce que fait le skill et les demandes qui doivent le déclencher.",
  "integrations.skills.createDescriptionPlaceholder": "Relire un lot de changements pour évaluer sa qualité, ses risques ou ses régressions.",
  "integrations.skills.createScope": "Disponibilité",
  "integrations.skills.createScopeDetail": "Un skill personnel fonctionne partout ; un skill projet reste dans cet espace de travail.",
  "integrations.skills.scope.user": "Tous les espaces de travail",
  "integrations.skills.scope.repo": "Cet espace de travail",
  "integrations.skills.createInstructions": "Instructions du workflow",
  "integrations.skills.createInstructionsDetail": "Utilisez un Markdown concis à l’impératif. N’ajoutez que ce que Codex ne peut pas déduire seul.",
  ...
  "integrations.plugins.planNotEligible": "Non disponible avec ce forfait",
  "integrations.plugins.requiredAppUnavailable": "App requise indisponible",
  "integrations.plugins.unavailable": "Indisponible",
  ...
  "thread.pinError": "Impossible de modifier l’épinglage de cette conversation",
  ...
  "sidebar.pinnedThreads": "Épinglées",
  "sidebar.pin": "Épingler",
  "sidebar.pinTitle": "Épingler la conversation",
  "sidebar.unpin": "Désépingler",
  "sidebar.unpinTitle": "Désépingler la conversation",
  ...
  "settings.group.agents": "Agents et capacités",
  ...
  "settings.section.automations": "Planificateur",
  ...
  "settings.section.advanced": "Importer depuis un autre agent",
  ...
  "automations.scheduleControl": "Planification",
  "automations.oneShotControl": "Exécution programmée",
  "automations.pause": "Mettre la planification en pause",
  "automations.resume": "Réactiver la planification",
  "automations.pauseOnce": "Suspendre l’exécution programmée",
  "automations.resumeOnce": "Réactiver l’exécution programmée",
