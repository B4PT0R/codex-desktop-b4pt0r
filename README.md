...
```bash
sudo apt install ./codex-desktop-linux_0.5.9_amd64.deb
```

### Fedora and RPM distributions

```bash
sudo dnf install ./codex-desktop-linux_0.5.9_x86_64.rpm
```
...
./codex-desktop-linux_0.5.9_x86_64.AppImage
```
...
```bash
APPIMAGE_EXTRACT_AND_RUN=1 ./codex-desktop-linux_0.5.9_x86_64.AppImage
```
...
sudo apt install ./dist/codex-desktop-linux_0.5.9_amd64.deb
```
