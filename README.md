...
```bash
sudo apt install ./codex-desktop-linux_0.5.7_amd64.deb
```

### Fedora and RPM distributions

```bash
sudo dnf install ./codex-desktop-linux_0.5.7_x86_64.rpm
```
...
```bash
chmod +x codex-desktop-linux_0.5.7_x86_64.AppImage
./codex-desktop-linux_0.5.7_x86_64.AppImage
```
...
```bash
APPIMAGE_EXTRACT_AND_RUN=1 ./codex-desktop-linux_0.5.7_x86_64.AppImage
```
...
sudo apt install ./dist/codex-desktop-linux_0.5.7_amd64.deb
```
